...
public class PostControllerTest {
  ...
  public void successPostList() throws Exception {
    ...
    files.add(
        new File(absolutePath + "src/test/java/io/potatoy/syiary/post/assets/test1_image.jpeg"));
    files.add(
        new File(absolutePath + "src/test/java/io/potatoy/syiary/post/assets/test3_image.png"));
